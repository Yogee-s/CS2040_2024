...
TEST(List, test_public_return_head_value) {
   List list0{4,1,3,1,2};
   std::cout << "head value: " << list0.head() << "\n";
   EXPECT_EQ(list0.head(), 4);

   List list1{3,1,2};
   std::cout << "head value: " << list1.head() << "\n";
   EXPECT_EQ(list1.head(), 3);

   List list2{0};
   std::cout << "head value: " << list2.head() << "\n";
   EXPECT_EQ(list2.head(), 0);
}
